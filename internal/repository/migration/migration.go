...
const (
	...
	migrationAddUsageEventErrorDetails              = "20260711_add_usage_event_error_details"
)
...
func orderedMigrations() []databaseMigration {
	return []databaseMigration{
		...
		{version: migrationAddUsageEventErrorDetails, run: addUsageEventErrorDetailsMigration},
	}
}
