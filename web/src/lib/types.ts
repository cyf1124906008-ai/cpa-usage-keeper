...
export interface RealtimeConcurrencyPoint {
  bucket: string
  average_concurrency: number
  peak_concurrency: number
}

export interface RealtimeErrorLevelPoint {
  bucket: string
  failures: number
  failure_rate: number
}

export interface RealtimeBreakdownItem {
  key: string
  label: string
  count: number
  share: number
...
export interface RealtimeRecentError {
  timestamp: string
  request_id?: string
  status_code: number
  error_type: string
...
export interface RealtimeErrorSummary {
  total_failures: number
  failure_rate: number
  unknown_details: number
  status_codes: RealtimeBreakdownItem[]
  types: RealtimeBreakdownItem[]
  models: RealtimeBreakdownItem[]
  auth_files: RealtimeBreakdownItem[]
  endpoints: RealtimeBreakdownItem[]
  recent_errors: RealtimeRecentError[]
}
...
export interface OverviewRealtimeBlock {
  ...
  concurrency_level?: RealtimeConcurrencyPoint[]
  error_level?: RealtimeErrorLevelPoint[]
  errors?: RealtimeErrorSummary
  current_concurrency?: number
  gateway_peak_concurrency?: number
