...
describe('UsagePage custom date input bounds', () => {
  ...
  it('uses the first stored usage event as the earliest selectable Custom date', () => {
    expect(getCustomDateRangeBounds(
      Date.parse('2026-07-12T00:15:00.000+08:00'),
      'Asia/Shanghai',
      '2026-07-07T21:54:28.657000+08:00',
    )).toEqual({
      min: '2026-07-07',
      max: '2026-07-12',
    });
